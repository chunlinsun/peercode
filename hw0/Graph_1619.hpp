...
/** Type of es and sizes.
  ...
  class Node {
   public:
    ...
    bool operator==(const Node& n) const 
    {
      ...
      return bool(n.node_index == node_index);
    }
    ...
    bool operator<(const Node& n) const 
    {
	  ...
	  if(graph_ptr < n.graph_ptr)  return true;
      // graph_1 is larger than graph_2
	  if(graph_ptr > n.graph_ptr)  return false;
	  // graph_1 and graph_2 are same
      return bool(node_index < n.node_index);
    }
  ...
  bool has_node(const Node& n) const 
  {
    ...
    return bool(nodes.count(n.node_index)==1);
  }
  ...
  class Edge 
{
   public:
    ...
    Edge(node_type a, node_type b, size_type ind)
    {
		// HW0: YOUR CODE HERE
    ...
    {
		// HW0: YOUR CODE HERE
		return bool(node_1 == e.node_1 and node_2 == e.node_2);
    }
    ...
    {
		// HW0: YOUR CODE HERE
		return bool(edge_index < e.edge_index);
    }
  ...
  bool has_edge(const Node& a, const Node& b) const 
  {
	...
	return bool(endpts_edge.count(tup) == 1);
  }
  ...
  Edge add_edge(const Node& a, const Node& b) 
 {
	...
	{
		edge_type e = Edge(first, second, num_edg);
		edges[num_edg] = e;
	    node_tuple tup = std::make_tuple(first.node_index, second.node_index);
...
private:
	...
	std::map<size_type, node_type> nodes;
