...
class Graph {
 ...
 private:
  struct internal_node{
     ...
     Point point_;
     unsigned nid;
     internal_node(Graph* g,const Point p, unsigned i){
      graph_=g;
      point_=p;
      nid=i;
    }
 ...
 public:
  ...
  class Node {
   ...
   private:
    ...
    Node(Graph* g,const Point& p, unsigned i){
      realnode=new internal_node(g,p,i);
    }
    // HW0: YOUR CODE HERE
  ...
  Node add_node(const Point& position) {
    // HW0: YOUR CODE HERE
    nodelist.push_back(Node(this,position,nnode));
  ...
  bool has_edge(const Node& a, const Node& b) const {
    ...
    if(edgemap.count(ed)||edgemap.count(ed2)){
      return true;
    }
