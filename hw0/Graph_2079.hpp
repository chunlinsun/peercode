...
class Graph {
 ...
 public:
  ...
  class Node {
   public:
    ...
    const Point& position() const {
      // HW0: YOUR CODE HERE
      return graph_ptr->nodes[node_id];
    }
    ...
    const graph_type* get_graph_ptr() const {
          return graph_ptr;
    }
    ...
    bool operator==(const Node& n) const {
      // HW0: YOUR CODE HERE
        if (graph_ptr == n.get_graph_ptr() && node_id == n.index()) {
            return true;
        }
        return false;
    }
    ...
    bool operator<(const Node& n) const {
      // HW0: YOUR CODE HERE
        ...
        if (node_id < n.index() && graph_ptr == n.get_graph_ptr()) {
            return true;
        }
        return false;
    }
  ...
  bool has_node(const Node& n) const {
    // HW0: YOUR CODE HERE
    return (n.get_graph_ptr() == this && n.index() < n_nodes);
  }
  ...
  class Edge {
   public:
    ...
    /** Get the private members of the edge */
      graph_type* get_graph_ptr() const{
          return graph_ptr;
      }
   ...
   private:
    ...
    Edge(const graph_type* g_ptr, size_type node1, size_type node2, size_type edge): graph_ptr(const_cast<graph_type*>(g_ptr)), node1_id(node1), node2_id(node2),
        edge_id(edge) {}
  };
 ...
 private:
  ...
  //   helper functions, data members, and so forth.
    std::vector<Point> nodes; // vector of struct
