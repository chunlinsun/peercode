...
class Graph {
 ...
 public:
  ...
  Node add_node(const Point& position) {
    ...
    nodes_.push_back(internal_node(position, size_, inc_edges));
    ++size_;
 ...
 private:
  ...
  struct internal_node {
    ...
    internal_node(Point point, size_type id, std::vector<incident_edge> inc_e): p(point), uid(id), inc_edges(inc_e) {};
  };
