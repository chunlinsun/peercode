...
/** NOTE to my TA:
 * @ My remove_node or remove_edge functions have bugs from HW2 and debugging
 * was not successful, so for HW3 I copied from peercode Graph_1164.hpp, to
 * proceed for HW3.
 * @ My own Graph.hpp was renamed to Graph0.hpp in the repo
 */
...
public:
    ...
    public:
        ...
        size_type degree() const {
            try {
                return g_->adj_list.at(uid).size();
