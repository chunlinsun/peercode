...
class Graph {
 ...
 public:
   ...
   */
 Graph() : v_index(0), node_idx(), edge_idx(), graph_nodes(), graph_edges(), next_nid(0), next_eid(0), node_size(0), edge_size(0)  { 
  // HW0: YOUR CODE HERE
  }
...
Point& position() {
   ...
   */
     ...
     Node add_node(const Point& position,const node_value_type& n_val = node_value_type())  {
        ...
        node_size++;
        v_index.push_back(v_index.size());
        //Return this node.
