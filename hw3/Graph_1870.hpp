...
// this file is obtained from the peer codes (Graph_299.hpp)
...
class Graph {
private:
  // predeclarations of internal_node and internal_edge
...
///////////////////////////////////////////////////////////////////
  ...
  */
  node_iterator remove_node(node_iterator n_it){
    ...
    return NodeIterator(this, n_next.index());
  }
///////////////////////////////////////////////////////////////////
  //
  // EDGES
  ...
  */
  ...
  class IncidentIterator {
   ...
   private:
    ...
    IncidentIterator(const Graph* graph_, size_type ind_node_, size_type curr_edge_) 
    : graph_{graph_}, ind_node_{ind_node_}, curr_edge_{curr_edge_} {}
  ...
  class EdgeIterator {
   public:
    ...
    /**Dereferences operator*/
    Edge operator*() const {
      internal_edge e_ = edge_iter->second;

      return Edge(graph_, e_.n1_, e_.n2_, edge_iter->first);
    }

    /**Defines equality between two incident iterators*/
    bool operator==(const EdgeIterator& ei) const {
      if (ei.graph_ == graph_ && ei.edge_iter == edge_iter) {
        return true;
      }
      return false;
    }
    ...
    */
    ...
    EdgeIterator(typename std::map<size_type, internal_edge>::const_iterator it, const Graph* graph_)
    : edge_iter(it), graph_{graph_} {}

   private:
    friend class Graph ;

    typename std::map<size_type, internal_edge>::const_iterator edge_iter;
    const Graph* graph_ ;
  };
