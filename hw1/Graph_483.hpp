...
//--documentation_-1
//--good doxygen docs, but consider putting some info in @pre/@post
//--END
/** @class Graph
...
public:
     ...
     */
//--design_0
//--You should make this faster now that you have an  IncidentEdgestoNodes
//--START
...
private:
    ...
    // NodesIndex[i] is the index of the node in the i-th location in the InternalNodes
    std::vector<size_type> NodesIndex;
    // NodesID[i] is the  location in the InteralNodes of the nodex indexed by i
