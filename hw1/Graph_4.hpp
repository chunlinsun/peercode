...
//--documentation_0
//--Good documentation although not all doxygen style. Consider adding info 
//--to @pre/@post specifications
//--END
...
// ------------------------- End: Edge class --------------------------
   ...
   */
//--design_0
//--you should speed this up now that you have graphEdgesIncidentToNode
//--START
